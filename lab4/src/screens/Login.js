...
export default Login = ({navigation})=>{
    ...
    return (
        <View style={{flex:1, justifyContent:"center", alignContent:"center", backgroundColor:"pink"}}>
            <Text style={{fontSize: 40, fontWeight: "bold", alignSelf:"center", color:"black" , marginBottom: 30
        }}>
            Login
        </Text>
